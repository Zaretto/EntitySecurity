namespace Zaretto.Security
{
    ...
    {
        internal static ulong ComputeHash(string xt)
        {
            return sdbm(xt);
        }
    ...
    ///// <summary>
    ///// Fast Hash class - works with 16byte (128 bit) values.
    ///// </summary>
    //public class FastHash2
    //{
    //    static Murmur3 hasher = new Murmur3();

    //    internal static ulong ComputeHash(byte[] p)
    //    {
    //        return hasher.ComputeHash(p);
    //    }

    //    internal static ulong ComputeHash(string xt)
    //    {
    //        return hasher.ComputeHash(Encoding.ASCII.GetBytes(xt));
    //    }
    //}

...
namespace ReferenceMonitorTests
{
    ...
    public class ReferenceMonitorTests
    {
        ...
        public void TestReferenceMonitor()
        {
            ...
            var g2read = new TestGroup(readGroupId2, Operation.Read);
            var g1write = new TestGroup(writeGroupId1, Operation.Write.Append(Operation.Read).Append(Operation.Delete));
            var g2write = new TestGroup(writeGroupId2, Operation.Write);
        ...
        public void TestReadWriteGroups()
        {
            //var u1 = new TestUser(1);
            var g1read = new TestGroup(readGroupId1, Operation.Read);
            var g1write = new TestGroup(writeGroupId1, Operation.Read);

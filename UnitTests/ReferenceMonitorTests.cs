...
namespace ReferenceMonitorTests
{
    ...
    public class ReferenceMonitorTests
    {
        ...
        public void TestReadWriteGroups()
        {
            //var u1 = new TestUser(1);
            var g1read = new TestGroup(readGroupId1, IControlledObjectOperation.Read);
            var g1write = new TestGroup(writeGroupId1, IControlledObjectOperation.Read);
        ...
        public void Privileges()
        {
            ...
            Assert.IsFalse(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Read, User1, o1));
            Assert.IsFalse(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Write, User1, o1));
            Assert.IsFalse(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Delete, User1, o1));
            Assert.IsTrue(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Security, User1, o1));
            Assert.IsFalse(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Create, User1, o1));
            ...
            User1.AddPrivilege(Privilege.BYPASS);
            Assert.IsTrue(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Read, User1, o1));
            Assert.IsTrue(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Write, User1, o1));
            Assert.IsTrue(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Delete, User1, o1));
            Assert.IsTrue(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Security, User1, o1));
            Assert.IsTrue(ReferenceMonitor.IsPermitted(Zaretto.Security.IControlledObjectOperation.Create, User1, o1));
